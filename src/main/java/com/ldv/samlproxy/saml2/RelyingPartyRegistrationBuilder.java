...
public class RelyingPartyRegistrationBuilder {
    ...
    public List<RelyingPartyRegistration> build(Saml2RelyingPartyProperties properties) {
        return properties.getRegistration().entrySet().stream().map(this::asRegistration).collect(Collectors.toList());
    }
